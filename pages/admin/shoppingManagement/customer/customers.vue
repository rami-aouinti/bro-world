...
const headers: DataTableHeaders = [
  { title: 'Email', key: 'email', type: 'text', list: true, show: true, create: false, edit: false },
  { title: 'First name', key: 'firstName', type: 'text', list: true, show: true, create: false, edit: false },
  { title: 'Last name', key: 'lastName', type: 'text', list: true, show: true, create: true, edit: true },
  { title: 'Enabled', key: 'user.enabled', type: 'boolean', list: true, show: true ,create: true, edit: true },
  { title: 'Verified', key: 'user.verified', type: 'boolean', list: true, show: true ,create: true, edit: true },
...
const loadProducts = async () => {
  loading.value = true
  try {
    const raw = await $fetch('/api/admin/shop/customer/customers/customers', { responseType: 'text' })
