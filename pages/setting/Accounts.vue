    ...
    <div class="px-6 pb-6 pt-4">
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg width="48" height="48" src="/img/small-logos/logo-slack.svg" alt="Avatar" />
        </v-avatar>
        <div>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg width="48" height="48" src="/img/small-logos/logo-spotify.svg" alt="Avatar" />
        </v-avatar>
        <div>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg width="48" height="48" src="/img/small-logos/logo-atlassian.svg" alt="Avatar" />
        </v-avatar>
        <div>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg width="48" height="48" src="/img/small-logos/logo-asana.svg" alt="Avatar" />
        </v-avatar>
        <div>
