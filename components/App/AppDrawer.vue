...
import { mergeProps, ref, computed, onMounted } from 'vue'
    ...
    <template #prepend>
      <v-list role="navigation" aria-label="Brand">
        ...
        >
          ...
          <!-- Affiche texte seulement si drawer est ouvert -->
          <v-list-item-title class="text-h6 font-weight-bold" v-if="drawer">
