...
const loadBlog = async () => {
  const data = await $fetch(`/api/posts/blog/${slug}/blog`)
  if (data) {
    blog.value = data
  }
  pending.value = false
            ...
            <v-row align="center" class="pa-0 ma-0">
              <v-col cols="auto">
                <v-avatar size="50" class="border-primary border-lg rounded-circle">
                  <NuxtImg format="webp" loading="lazy" cover width="50" height="50" :src="blog.logo" alt="Avatar" />
                </v-avatar>
              </v-col>
              <v-col cols="auto">
                <div>
                ...
                >
                  ...
                  <v-list class="pa-2">
                    <v-list-item class="list-item-hover-active border-radius-md">
                      <v-list-item-title class="text-body-2 ls-0 text-body font-weight-600 py-2">
                        Edit Team
                      </v-list-item-title>
                    </v-list-item>
                    ...
                    <v-list-item class="list-item-hover-active border-radius-md">
                      <v-list-item-title class="text-danger ls-0 font-weight-600 mb-0">
                        Remove Team
                      </v-list-item-title>
                    </v-list-item>
                  </v-list>
