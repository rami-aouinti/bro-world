...
const USER_1_IDENTITY = 'your_user_id'
const USER_1_PASSWORD = 'your_password'
...
const fetchToken = async () => {
  ...
  if (fetchError.value) {
    error.value = 'Erreur lors de la récupération du token'
    return
  }

  tokenSdk.value = data.value as string
}
