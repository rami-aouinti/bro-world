      ...
      <template #item="{ element, index }">
        <div class="row">
          ...
          <div class="meter dots">
            <span v-for="n in maxLevel" :key="n" class="dot"
                  :class="{ on: n <= element.level }"
...
.dots .dot { display: inline-block; border-radius: 50%; background: #d2d2d2; cursor: pointer; }
.dots .dot.on { background: var(--accent, #b88b6a); }
