...
const dateStr = dayjs(props.newEventDate).format('YYYY-MM-DD')
const start = `${dateStr} ${props.newEventStartTime}`
const end = `${dateStr} ${props.newEventEndTime}`

const newEvent = {
  id: Math.random().toString(36).substring(2),
  title: props.newEventTitle || 'Untitled Event',
  time: { start, end },
  isEditable: true,
