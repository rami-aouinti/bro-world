...
const cards = [
  ...
  {
    image: '@/assets/img/home-decor-4.jpg',
    title: 'Project #4',
    style: 'Gothic',
    description:
...
<template>
  <v-container fluid>
    <v-row>
      <v-col lg="12">
        <v-card rounded="xl" class="py-4" elevation="24">
          <div class="px-5">
            <v-row>
              <v-col cols="auto">
                <v-avatar
    ...
    <v-row>
      <v-col lg="4" md="4" cols="12" class="position-relative">
        <v-card rounded="xl" class="h-60" elevation="24">
          <div class="px-4 pt-4">
      ...
      <v-col lg="4" md="4" cols="12" class="position-relative">
        <v-card rounded="xl" class="h-100" elevation="24">
          <div class="px-4 pt-4">
