    ...
    <div class="px-6 pb-6 pt-4">
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg format="webp" width="48" height="48" src="https://bro-world-space.com/img/small-logos/logo-slack.svg" alt="Avatar" />
        </v-avatar>
        <div>
          <h5 class="mb-0 text-typo text-h5 font-weight-bold">Slack</h5>
          <a class="text-sm text-body text-decoration-none" href="javascript:;">
            Show less
            <i class="fas fa-chevron-up text-xs ms-1" aria-hidden="true" />
          </a>
        </div>
        <p
          v-if="switch1 === true"
      ...
      <div class="ps-12 pt-5 ms-4">
        ...
        >
          ...
          <h6
            class="text-sm ms-auto font-weight-bold text-typo me-3 my-auto ms-auto"
          >
          ...
          <v-btn
            :elevation="24"
            color="#cb0c9f"
            class="font-weight-bolder btn-default bg-gradient-default px-4 mt-auto"
            small
          >
            Delete
          </v-btn>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg format="webp" width="48" height="48" src="https://bro-world-space.com/img/small-logos/logo-spotify.svg" alt="Avatar" />
        </v-avatar>
        <div>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg format="webp" width="48" height="48" src="https://bro-world-space.com/img/small-logos/logo-atlassian.svg" alt="Avatar" />
        </v-avatar>
        <div>
      ...
      <div class="d-flex align-center">
        <v-avatar width="48" height="48" class="border-radius-lg me-4">
          <NuxtImg format="webp" width="48" height="48" src="https://bro-world-space.com/img/small-logos/logo-asana.svg" alt="Avatar" />
        </v-avatar>
        <div>
